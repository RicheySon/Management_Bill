...
const propertySchema = Joi.object({
    ...
    property_use: Joi.string().required().min(1),
    building_type: Joi.string().required().min(1),
    no_of_storeys: Joi.number().integer().min(0).required(),
    ownership: Joi.string().required().min(1),
    building_permit_status: Joi.string().required().min(1),
    account_number: Joi.string().required().min(1),
    parcel_number: Joi.string().required().min(1),
    house_number: Joi.string().required().min(1),
    source_of_water: Joi.string().required().min(1),
    sanitation_facility: Joi.string().required().min(1),
    solid_waste_disposal: Joi.string().required().min(1),
    liquid_waste_disposal: Joi.string().required().min(1),
    no_of_people: Joi.number().integer().min(0).required(),
    no_of_bedrooms: Joi.number().integer().min(0).required(),
    no_of_washrooms: Joi.number().integer().min(0).required(),
    no_of_other_rooms: Joi.number().integer().min(0).required(),
    street_name: Joi.string().required().min(1),
    gps_address: Joi.string().required().min(1).max(50),
    latitude: Joi.number().precision(8).min(-90).max(90).required(),
    longitude: Joi.number().precision(8).min(-180).max(180).required(),
    town: Joi.string().required().min(1),
    physical_location: Joi.string().optional().allow('', null),
    landmark: Joi.string().required().min(1),
    electoral_area_id: Joi.number().integer().required(),
    local_area_id: Joi.number().integer().required(),
    population_density: Joi.string().required().min(1),
    property_size: Joi.number().min(0).required(),
    ...
    assessed_amount: Joi.number().min(0.01).required(),
